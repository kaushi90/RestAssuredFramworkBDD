...
public class TestApp {
    ...
    public void eEbillRegStatusAPI() throws Exception {
        ...
        Response response = given().
                ...
                get("https://mife-stg.dialog.lk/apicall/crm/regStatusService/v1.0.0/rest/api/getEbillRegStatus/msisdn/{mobilenum}",mobilenum);
        ...
        given().
                ...
                contentType("application/json").
                header("Authorization", accessToken).
                get("https://mife-stg.dialog.lk/apicall/crm/InvoiceStatusRetrieval/v1.0.0/rest/api/getManualInvoiceStatus/Msisdn/{mobilenum}",mobilenum);
        System.out.println(response.getBody().asString());
        Assert.assertEquals(response.getStatusCode(), 200);
        ...
        given().
                ...
                get("https://mife-stg.dialog.lk/apicall/crm/ebillService/v1.0.0/rest/api/getEbillAddress/Msisdn/{mobilenum}",mobilenum);
        ...
        given().
                ...
                contentType("application/json").
                header("Authorization", accessToken).
                get("https://mife-stg.dialog.lk/apicall/crm/connectionDetails/v1.0.0/rest/api/CDMALTEConnection/{telbizContno}",telbizContno);
        Assert.assertEquals(response.getStatusCode(), 200);
...
@Test
    public void ActivaeEbill() throws Exception
    {
        ...
        Response response = given().
                when().
                contentType("application/json").
                header("Authorization", "af6e6d30bbd6d0481c6ff6f13aa429a7").
                body("{\"status\": \"1\" }").
                post("https://mife-stg.dialog.lk/apicall/crm/activateDetailBill/v1.0.0/rest/api/activateDetailBill/{mobilenum}",mobilenum);
        JsonPath jsonPathPost = new JsonPath(response.asString());
        String descriptione = jsonPathPost.getString("description");
