...
public class TestAppCCBS {
    ...
    public void AutomationCCBSOne() throws Exception {
        ...
        Response response = given().
                ...
                get("https://mife-stg.dialog.lk/apicall/crm/regStatusService/v1.0.0/rest/api/getEbillRegStatus/msisdn/{CCBS_MSISDN}",CCBS_MSISDN);
        ...
        given().
                ...
                contentType("application/json").
                header("Authorization", accessToken).
                get("https://mife-stg.dialog.lk/apicall/crm/InvoiceStatusRetrieval/v1.0.0/rest/api/getManualInvoiceStatus/Msisdn/{CCBS_MSISDN}",CCBS_MSISDN);
        System.out.println(response.getBody().asString());
        Assert.assertEquals(response.getStatusCode(), 200);
        ...
        given().
                ...
                get("https://mife-stg.dialog.lk/apicall/crm/ebillService/v1.0.0/rest/api/getEbillAddress/Msisdn/{CCBS_MSISDN}",CCBS_MSISDN);
        ...
        given().
                ...
                contentType("application/json").
                header("Authorization", accessToken).
                get("https://mife-stg.dialog.lk/apicall/crm/connectionDetails/v1.0.0/rest/api/CDMALTEConnection/{CCBSCONTRNO}",CCBSCONTRNO);
        Assert.assertEquals(response.getStatusCode(), 200);
...
//             Assert.assertEquals(aa,substatus);
        ...
        given().
                ...
                header("Authorization", accessToken).
                body("{\"status\": \"1\" }").
                post("https://mife-stg.dialog.lk/apicall/crm/activateDetailBill/v1.0.0/rest/api/activateDetailBill/{CCBS_MSISDN}",CCBS_MSISDN);
...
//        if (descriptione=="Already Active")
//
//        {
//            given().
//                    when().
//                    contentType("application/json").
//                    header("Authorization", "Bearer afcdc6da2de13d1fa31b8169ec3c6c4").
//                    body("{\"status\": \"0\" }").
//                    post("https://mife-stg.dialog.lk/apicall/crm/activateDetailBill/v1.0.0/rest/api/activateDetailBill/{mobilenum}",mobilenum);
//
//
