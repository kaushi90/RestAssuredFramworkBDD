    ...
    public static String getAccessTokenKey() {
        ...
        try {
            ...
            Response response = given().
                    when().
                    header("Authorization", "Basic OVI5YUFraVkxeFdKSmEwZDRjX3YyUHFzaVBBYTp1QWgyR3BoZ1Y5c2VEdmxlMUhmZVZpM2ViNmNh").

                    post ("https://mife-stg.dialog.lk/apicall/token?grant_type=password&username=GITCRM&password=GITCRM&scope=SANDBOX");
